...
/* USER CODE END 0 */
  ...
  volatile static enum {ST_PEDESTRIAN_CROSSING, ST_AMBAR_SEM, ST_VEHICLES_CROSSING, ST_BLINKING_GREEN_PEDESTRIAN} next_state;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
      ...
      case ST_PEDESTRIAN_CROSSING:
        ...
        HAL_Delay(g_delay_pedestrian_sem);
